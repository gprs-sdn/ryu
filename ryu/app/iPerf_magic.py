...
#                                                              #
#                                                              #
# HIGLY EXPERIMENTAL VERSION OF CONTROLLER FOR WMNC CONFERENCE # 
#                                                              #
#                                                              #
################################################################
...
class plainMacTunnel:
    ...
    Keyword arguments:
        ...
        path_in -- list of links for incoming direction
    """
    def __init__(self,_sApn_, _dApn_, _tid_out, _tid_in, path_out=None, path_in=None):
      self.sApn = _sApn_
      self.dApn = _dApn_
      self.tid_out = _tid_out
      self.tid_in = _tid_in
...
# WMNC: added for performance test
APN_POOL.append(apn('iperfclient'))
APN_POOL.append(apn('iperfserver'))
